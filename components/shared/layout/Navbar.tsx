...
const Navbar = () => {
  return (
    <header className="backdrop-blur-[5px] bg-white/70 dark:bg-dark1/70 max-md:border-b border-b dark:border-b-dark2 fixed z-30 left-0 top-0 right-0 p-4 pl-[280px] lg:pl-[270px] max-md:pl-4 md:pr-12">
